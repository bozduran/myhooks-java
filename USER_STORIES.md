...
- **Done:** US-00 (scaffold), US-01 (`xmlspan`), US-02 (`edit`), US-03 (`textrules`), US-04 (`diffui`).
...
- **Next:** US-05 — `refactor(discover,git): add memoized file discovery and git plumbing`.
